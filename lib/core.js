...
async function adminSaveDestinations(ctx, text) {
  ...
  await db.kvSet(K.dest, JSON.stringify(clean));
  return adminOverview(ctx);
}
...
module.exports = {
  ...
  // admin
  requireAdmin, adminOverview, adminSaveConfig, adminSaveDestinations,
  adminAddSamples, adminRemoveSamples, adminSampleVotes, adminResetVoting,
